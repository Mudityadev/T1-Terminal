  ...
  return (
    <div className="min-h-screen bg-[var(--t1-bg-primary)] flex items-center justify-center p-6 grid-pattern">
      <div className="w-full max-w-sm space-y-6">
        ...
        {/* Logo */}
        <FadeIn delay={0} duration={600} direction="down">
          <div className="text-center space-y-2">
            <div className="inline-flex items-center gap-2 px-4 py-2 glass rounded-xl border border-[var(--t1-border-glow)] animate-glow-heartbeat">
        ...
        {/* Sign-in Card */}
        <FadeIn delay={120} duration={700} direction="up">
        ...
        {/* Back */}
        <FadeIn delay={250} duration={500} direction="up">
      ...
      {showSignUpPopup && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={() => setShowSignUpPopup(false)}>
          ...
          <div className="relative w-full max-w-sm glass rounded-2xl border border-[var(--t1-border-glow)] p-6 text-center space-y-4 animate-fade-in-blur"
